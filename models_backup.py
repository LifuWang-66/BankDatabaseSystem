...
class Access(models.Model):
    perid = models.ForeignKey('Customer', models.DO_NOTHING, related_name='+', db_column='perID')  # Field name made lowercase.
    bankid = models.OneToOneField('BankAccount', models.DO_NOTHING, db_column='bankID', primary_key=True)  # Field name made lowercase.
    accountid = models.ForeignKey('BankAccount', models.DO_NOTHING, related_name='+', db_column='accountID')  # Field name made lowercase.
...
class Checking(models.Model):
    ...
    protectionaccount = models.ForeignKey('Savings', models.DO_NOTHING, related_name='+', db_column='protectionAccount', blank=True, null=True)  # Field name made lowercase.
...
class InterestBearingFees(models.Model):
    ...
    accountid = models.ForeignKey(InterestBearing, models.DO_NOTHING, related_name='+', db_column='accountID')  # Field name made lowercase.
